  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8">
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-gray-600">OpenCode ヘッドレスサーバーの管理ダッシュボード</p>
      </div>
      ...
      <div className="w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <h2 className="text-xl font-semibold mb-2 text-purple-800">OpenCode Web UI &rarr;</h2>
            <p className="text-sm text-purple-600">opencode の Web UI をブラウザで操作</p>
          </Link>
          <Link
            href="/sessions"
          ...
          >
            ...
            <p className="text-sm text-gray-500">実行中のセッション一覧と詳細を確認</p>
          </Link>
          <Link
            href="/sessions/new"
            className="rounded-lg border p-6 hover:shadow-lg transition-shadow"
          >
            ...
            <p className="text-sm text-gray-500">新しい opencode セッションを開始</p>
          </Link>
          <Link
            href="/settings"
            className="rounded-lg border p-6 hover:shadow-lg transition-shadow"
          >
            ...
            <p className="text-sm text-gray-500">トークン・リポジトリ設定の管理</p>
          </Link>
        </div>
